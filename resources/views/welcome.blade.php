                ...
                <div class="room-wrap-2">
                    <!-- ITEM -->
                     @foreach($marriagehall as $mk=>$p)
                        ...
                        ?>
                        <div class="img">
                            <a href="#"><img src="storage/app/public/upload/admin/<?php echo $p->name?>/<?php echo $image[0]?>">
                        </div>
                        @else
                        <?php
                         $image=json_decode($p->img,true);
                        ?>
                        <div class="img">
                            <a href="#"><img src="storage/app/public/upload/subadmin/<?php echo $p->name?>/<?php echo $image[0];?>" alt="" height="30px" width="30px"></a>
                        </div>
                        @endif
                        <div class="text">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="room-detail_img">
                                <div class="room_img-item">
                                     @if($p->user_type=='1')
                                    <img src="storage/app/public/upload/admin/<?php echo $p->name?>/<?php echo $image[0]?>" alt=""
                                    style="width: 580px;height: 300px;">
                                    @else
                                    <img src="storage/app/public/upload/subadmin/<?php echo $p->name?>/<?php echo $image[0]?>" alt="">
                                    @endif    
                                </div>
                                @if(isset($image[1]))
                                <div class="room_img-item">
                                    @if($p->user_type=='1')
                                    <img src="storage/app/public/upload/admin/<?php echo $p->name?>/<?php echo $image[1]?>" alt="">
                                    @else
                                    <img src="storage/app/public/upload/subadmin/<?php echo $p->name?>/<?php echo $image[1]?>" alt="">
                                     @endif
                                ...
                                <div class="room_img-item">
                                    @if($p->user_type=='1')
                                    <img src="storage/app/public/upload/admin/<?php echo $p->name?>/<?php echo $image[2]?>" alt="">
                                       @else
                                    <img src="storage/app/public/upload/subadmin/<?php echo $p->name?>/<?php echo $image[2]?>" alt="">  
                                     @endif  
                                </div>
                                @endif
                                  @if(isset($image[3]))
                                <div class="room_img-item">
                                    @if($p->user_type=='1')
                                    <img src="storage/app/public/upload/admin/<?php echo $p->name?>/<?php echo $image[3]?>" alt="">
                                    @else
                                    <img src="storage/app/public/upload/subadmin/<?php echo $p->name?>/<?php echo $image[3]?>" alt="">
                                     @endif    
                                </div>
                                @endif
                                 @if(isset($image[4]))
                                <div class="room_img-item">
                                    @if($p->user_type=='1')
                                    <img src="storage/app/public/upload/admin/<?php echo $p->name?>/<?php echo $image[4]?>" alt="">
                                       @else
                                    <img src="storage/app/public/upload/subadmin/<?php echo $p->name?>/<?php echo $image[4]?>" alt="">
                                     @endif    
                                </div>
                                @endif
                            </div>
                ...
                <div class="room-wrap-2">
                    <!-- ITEM -->
                     @foreach($eventhall as $mk=>$p)
                        ...
                        ?>
                        <div class="img">
                            <a href="#"><img src="storage/app/public/public/app/upload/admin/<?php echo $p->name?>/<?php echo $image[0]?>">
                        </div>
                        @else
                        <?php
                         $image=json_decode($p->img,true);
                        ?>
                        <div class="img">
                            <a href="#"><img src="storage/app/public/public/app/upload/subadmin/<?php echo $p->name?>/<?php echo $image[0];?>" alt="" height="30px" width="30px"></a>
                        </div>
                        @endif
                        <div class="text">
                            <h3 class='text-uppercase' ><?php echo 'Hall Name :-'." ".$p->name;?></h3>
