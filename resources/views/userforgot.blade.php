...
<div class="container">
	<div class="d-flex justify-content-center h-100">
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="card-body">
			      <a href="">
			      <img src="{{asset('')}}" alt="User Image" style="width: 95px;height: 60px;"><span style="color:white;font-size:22px; font-family: 'Merienda', cursive;vertical-align: middle;"  >WAYTOBOOKING</span>   
			      </a>
				<form action="{{url('userpasswordreset')}}" method="post" name="forgotpassword" id="forgotpassword" enctype="multipart/form-data">
					...
					<div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-phone" style="font-size:15px;"></i></span>
						</div>
					...
					<div class="input-group form-group">
						...
						<span class="error" style="color:red" style="font-size:13px;"></span><br/>
					</div>
					<div class="form-group">
						<button type="submit"class="btn float-right login_btn" style="font-size:16px;">Reset</button>	
					</div>
				</form>""
        </div>
    </body>
