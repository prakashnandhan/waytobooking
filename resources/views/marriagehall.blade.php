...
<form action="{{ url('savemarriagedetails') }}" method="post" enctype="multipart/form-data" >
  ...
  <div class="container-fluid" style="background-color:white;">
    <h3 style="text-align: center;">MARRIAGE HALL DEATILS</h3>
   <div class="row">
    ...
    <input type="number" class="form-control"  placeholder="advanceprice" name="advanceprice" id="advanceprice" required>
     ...
     <div class="col-md-6 form-group" >
     <label><b>IMAGES UPLOAD</b></label>
     <input type="file" name="img[]"    id="img" multiple required>
     </div>
     <div class="col-md-6 form-group" >
     <label><b>AC OR NONAC</b></label><br>
     <input type="radio" name="roomtype" id="AC" value="AC" ><b>AC</b><br>
     <input type="radio" name="roomtype" id="NONAC" value="NONAC" CHECKED><b>NONAC</b>
     </div>
...
<div style="overflow-x:auto; ">
  ...
  <table class=" table table-bordered table-hover" id="table1">
    ...
    <tbody>
      ...
      <tr>
        <td style="display: none;"><?php echo $value->marriageid ?></td>
        ...
        <td><?php echo $value->parking ?></td>
         <td>
          <button type="button"  class="btn btn-success edit" 
             marriageid="<?php echo $value->marriageid; ?>"
            ...
            >Edit</button> 
            <button class="btn btn-danger del" id="del" marriageid="<?php echo $value->marriageid; ?>">delete</button>
         </td>     
      </tr>
      <?php } ?>
    </tbody>
