        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/avatar5.png " class="img-circle" alt="User Image" style="width: 20px;
              height: 20px;">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php
                  echo request()->session()->get('useremail');
                 ?> 
                  <small></small>
                </p>
              </li>
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="{{url('subadminsignout')}}" class="btn btn-danger btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" id="menu" >
       <!--  <li class="header">MAIN NAVIGATION</li> -->
        ...
        <li><a  href="{{ url('subadmindashboard')}}"><i class="fa fa-dashboard"></i>DASHBOARD</a></li>
    <!--  <li>
          <a href="{{url('subadminprofile')}}">
             <i class="fa fa-users"></i> <span>MY Profile</span>
          </a>
        </li> -->
         <li class=" treeview">
          <a href="#">
            <i class="glyphicon glyphicon-plus-sign"></i> <span>ADD HALL</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
           <ul class="treeview-menu">
            <li><a  href="{{ url('submarriage')}}"><i class="fa fa-circle-o"></i>MARRIEGE HALLS</a></li>
            <li><a  href="{{ url('subparty')}}"><i class="fa fa-circle-o"></i>PARTY HALL</a></li>
            <li><a  href="{{ url('subevent')}}"><i class="fa fa-circle-o"></i>EVENT HALL</a></li>
            <li><a  href="{{ url('subresort')}}"><i class="fa fa-circle-o"></i>RESORTS</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
         ...
         <ul class="treeview-menu">
          <li ><a href="{{ url('addsubpackage')}}"><i class="fa fa-circle-o"></i>Add Pacakage </a></li>
            </ul>
            </li>
          ...
          <a href="#">
            <i class="fa fa-info-circle" ></i>
            <span>MANAGE HALL DATES</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
         <ul class="treeview-menu">
          <li ><a href="{{ url('sub_managehall')}}"><i class="fa fa-circle-o"></i>HALL AVAILABILITY</a></li>
            </ul>
            </li>
     
      <!--   <li class="treeview">
          <a href="#">
            <i class="fa fa-files-o"></i> <span>Manage Hall</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li ><a href="{{url('managemarriage')}}"><i class="fa fa-circle-o"></i>MARRIEGE HALL</a></li>
            <li><a href="{{ url('manageparty')}}"><i class="fa fa-circle-o"></i>PARTY HALL</a></li>
            <li><a href="{{ url('manageevent')}}"><i class="fa fa-circle-o"></i>EVENT HALL</a></li>
            <li><a href="{{ url('manageresort')}}"><i class="fa fa-circle-o"></i>RESORTS</a></li>
          </ul>
        </li>  -->
        <!-- <li class="treeview">
          <a href="#">
