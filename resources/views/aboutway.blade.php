            ...
            <div class="sub-banner">
                <div class="container">
                    <div class="text text-center">
                        <h2>ABOUT Waytobooking</h2>
                        <p>It is booking app All you need</p>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="about">
                    ...
                    <div class="about-item">
                        ...
                        <div class="text">
                            <h2 class="heading">ABOUT Waytobooking</h2>
                            <div class="desc">
                    ...
                    <div class="about-item about-right">
                        ...
                        <div class="text">
                            <h2 class="heading">WHY GUEST CHOOSE WAYTOBOOKING APP?</h2>
                            <div class="desc">
        ...
        <section class="section-statistics bg-10">
            ...
            <div class="container">
                <div class="statistics">
                    ...
                    <h2 class="heading white text-center">Booking statistics</h2>
