...
<form action="{{ url('savepartydetails')}}" method="post" enctype="multipart/form-data" >
        ...
        <td><?php echo $value->parking ?></td>
         <td>
          <a><button type="button"  class="btn btn-success edit" 
            ...
            >Edit</button></a> 
            <button class="btn btn-danger del" id="del" partyid="<?php echo $value->partyid; ?>">delete</button>
         </td>     
      </tr>
      <?php } ?>
    </tbody>
