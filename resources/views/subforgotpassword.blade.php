...
<div class="container">
	<div class="d-flex justify-content-center h-100">
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="card-body">
			      <a href="">
			      <img src="{{asset('images/logo.svg')}}" alt="User Image" style="width: 95px;height: 60px;"><span style="color:white;font-size:22px; font-family: 'Merienda', cursive;vertical-align: middle;"  ><b>AYTOBOOKING</b></span>   
			      </a>
				<form action="{{url('subpasswordreset')}}" method="post" name="forgotpassword" id="forgotpassword" enctype="multipart/form-data">
