...
<form action="{{ url('saveeventdetails')}}" method="post" enctype="multipart/form-data" >
...
@endif
  <div class="container-fluid" style="background-color:white;">
    <h3 style="text-align: center;">EVENT HALL DEATILS</h3>
   <div class="row">
...
<div style="overflow-x:auto; " >
  <h2>Event hall List</h2>            
  <table class=" table table-bordered table-hover table2"  id='table2'>
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        <td style="display: none;"><?php echo $value->eventid ?></td>
        ...
        <td><?php echo $value->parking ?></td>
         <td>
          <button type="button"  class="btn btn-success edit" 
             marriageid="<?php echo $value->eventid; ?>"
             ...
             >Edit</button>
            <button class="btn btn-danger del" id="del" marriageid="<?php echo $value->eventid; ?>">delete</button>
         </td>     
      </tr>
      <?php } ?>
    </tbody>
