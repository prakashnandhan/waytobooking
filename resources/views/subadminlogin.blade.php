	...
	<div class="d-flex justify-content-center h-100">
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="card-body">
			      ...
			      <img src="{{asset('images/logo.svg')}}" alt="User Image" style="width: 95px;height: 60px;"><span style="color:white;font-size:22px; font-family: 'Merienda', cursive;vertical-align: middle;"  >AYTOBOOKING</span>   
					...
					@endif
				<form action="{{ url('subadminlogin')}}" method="post" enctype="multipart/form-data">
       ...
       <div class="card-footer">
				<div class="d-flex justify-content-center links">
					Don't have an account?<a href="{{url('subadminsignup')}}">Sign Up</a>
				</div>
				<div class="d-flex justify-content-center">
					<a href="{{url('subforgot')}}">Forgot your password?</a>
				</div>
			</div>
    </body>
